...
\noindent {\sc Espacio Académico:} {\bf \var{Espacio Académico}} \\
\noindent Código del Espacio: {\bf \var{Código del Espacio}} \qquad Número de Créditos: {\bf \var{Número de Créditos}} \\
...
\noindent Horas Trabajo Directo: {\bf \var{Horas Trabajo Directo}} \\ 
          Horas Trabajo Colaborativo: {\bf \var{Horas Trabajo Colaborativo}} \\ 
		  Horas Trabajo Autónomo: {\bf \var{Horas Trabajo Autónomo}} \\

\noindent\rule[0.8ex]{12.1cm}{0.25pt} \par
\noindent {\sc Categoría del Espacio Académico} \\
\begin{tabular}{lclc}
Obligatorio & (\var{Obligatorio})  & Electivo       & (\var{Electivo}) \\
Básico      & (\var{Básico})  & Complementario & (\var{Complementario}) \\
Intríseco   & (\var{Intríseco}) & Extrínseco     & (\var{Extrínseco}) \\
\end{tabular} \\

\noindent\rule[0.8ex]{12.1cm}{0.25pt} \par
\noindent {\sc Tipo de Curso} \\
\begin{tabular}{lclc}
Teórico          & (\var{Teórico}) & Práctico   & (\var{Práctico}) \\
...
Clase magistral & (\var{Clase magistral}) & Seminario & (\var{Seminario}) & Seminario-Taller & (\var{Seminario-Taller}) \\
Taller & (\var{Taller}) & Prácticas & (\var{Prácticas}) & Proyectos con tutoría & (\var{Proyectos con tutoría}) \\
\end{tabular} \\

\noindent\rule[0.8ex]{12.1cm}{0.25pt} \par
\noindent {\sc Conocimientos previos del curso} \\
\noindent Conocimientos sobre \var{Conocimientos previos del curso} \\
...
\varlist{Contenidos y Unidades Temáticas}
...
\varlist{Resultados de Aprendizaje}
